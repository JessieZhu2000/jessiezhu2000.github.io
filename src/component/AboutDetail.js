...
export default () => {
    return (
        <div className='about'>
            ...
            <h2>
                We offer professional dog walking services in-and-around Cambridgeshire. Please check out location page for more details about which areas we operate in.
            </h2>
            <h2>
