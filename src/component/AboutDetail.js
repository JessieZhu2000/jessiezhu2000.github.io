...
export default () => {
    return (
        <div className='about'>
            ...
            <h2>
                We offer professional dog walking services in-and-around Cambridgeshire. Please check out our Location page for more details about which areas we operation in.
            </h2>
            <h2>
